...
if 'kondisi' not in st.session_state:
    st.session_state['kondisi']={'awal':True,'contoh':False, 'Pertemuan1':False,'Pertemuan2':False,'Pertemuan3':False,
                                 ...
                                 'Pertemuan9':False, 'Pertemuan10':False, 'Pertemuan11':False,'Pertemuan12':False}
...
def materi6():
    ...
    with menu1[1]:
        tulisanHTML='''
        <iframe src="https://martin-bernard26.github.io/projekArtikel/projek3.html" style="width:100%; height:1000px"></iframe>
        '''
        st.components.v1.html(tulisanHTML,height=1000)
    with menu1[2]:
        ...
        st.components.v1.html(tulisanHTML,height=1000)
def materi7():
    menu2 = st.tabs(['Metode dan Model','Contoh'])
    with menu2[0]:
        tulisanHTML='''
        <iframe src="https://martin-bernard26.github.io/projekArtikel/MediaRnD.html" style="width:100%; height:1000px"></iframe>
        '''
        st.components.v1.html(tulisanHTML,height=1000)
    with menu2[1]:
        tulisanHTML='''
        <iframe src="https://martin-bernard26.github.io/projekArtikel/validasi1.html" style="width:100%; height:1000px"></iframe>
        '''
        st.components.v1.html(tulisanHTML,height=1000)
def materi8():
    menu2 = st.tabs(['Kemampuan Berpikir','Contoh Instrumen','Proses Berpikir'])
    with menu2[0]:
        tulisanHTML='''
        <iframe src="https://martin-bernard26.github.io/projekArtikel/kemampuan.html" style="width:100%; height:1000px"></iframe>
        '''
        st.components.v1.html(tulisanHTML,height=1000)
    with menu2[1]:
        tulisanHTML='''
        <iframe src="https://martin-bernard26.github.io/projekArtikel/taksonomiBloom.html" style="width:100%; height:1000px"></iframe>
        '''
        st.components.v1.html(tulisanHTML,height=1000)
    with menu2[2]:
        tulisanHTML='''
        <iframe src="https://martin-bernard26.github.io/projekArtikel/berpikir.html" style="width:100%; height:1000px"></iframe>
        '''
        st.components.v1.html(tulisanHTML,height=1000)
def materi9():
    tulisanHTML='''
        <iframe src="https://drive.google.com/file/d/1Z9xWaIJtuGE2aXDBBRvaATPjLgPy8fwm/preview" style="width:100%; height:1000px"></iframe>
        '''
    st.components.v1.html(tulisanHTML,height=1000)
    st.write("Kumpulkan tugas di link drive anda berupa pdf")
    tulisanHTML='''
        <iframe src="https://martin-bernard26.github.io/projekArtikel/UTS.html" style="width:100%; height:500px"></iframe>
        '''
    st.components.v1.html(tulisanHTML,height=500)
def materi10():
    menu = st.tabs(['Materi','Contoh Instrumen'])
    with menu[0]:
        tulisanHTML='''
            <iframe src="https://martin-bernard26.github.io/projekArtikel/AIC.html" style="width:100%; height:1000px"></iframe>
        '''
        st.components.v1.html(tulisanHTML,height=1000)
    with menu[1]:
        tulisanHTML='''
...
def materi13():
    tulisanHTML='''
            <iframe src="https://drive.google.com/file/d/1BeMlf-YVF06FOrEdGR5fpEwyDJAUug7z/preview" style="width:100%; height:1000px"></iframe>
            '''
    st.components.v1.html(tulisanHTML,height=1000)

def materi14():
    tulisanHTML='''
            <iframe src="https://martin-bernard26.github.io/projekArtikel/UASPGSD.html" style="width:100%; height:1000px"></iframe>
            '''
    st.components.v1.html(tulisanHTML,height=1000)
...
if st.sidebar.button("Pertemuan 8"):
    st.session_state['kondisi']={'awal':False,'contoh':False, 'Pertemuan1':False,'Pertemuan2':False,'Pertemuan3':False,
                                 'Pertemuan4':False,'Pertemuan5':False,'Pertemuan6':False,'Pertemuan7':False,'Pertemuan8':False,
                                 'Pertemuan9':True, 'Pertemuan10':False, 'Pertemuan11':False,'Pertemuan12':False}
    st.rerun()
if st.sidebar.button("NeuroSains"):
    st.session_state['kondisi']={'awal':False,'contoh':False, 'Pertemuan1':False,'Pertemuan2':False,'Pertemuan3':False,
                                 'Pertemuan4':False,'Pertemuan5':False,'Pertemuan6':False,'Pertemuan7':False,'Pertemuan8':False,
                                 'Pertemuan9':False, 'Pertemuan10':True, 'Pertemuan11':False,'Pertemuan12':False}
    st.rerun()
st.sidebar.markdown("---")
if st.sidebar.button("Ujian Akhir Semester"):
    st.session_state['kondisi']={'awal':False,'contoh':False, 'Pertemuan1':False,'Pertemuan2':False,'Pertemuan3':False,
                                 'Pertemuan4':False,'Pertemuan5':False,'Pertemuan6':False,'Pertemuan7':False,'Pertemuan8':False,
                                 'Pertemuan9':False, 'Pertemuan10':False, 'Pertemuan11':True,'Pertemuan12':False}
    st.rerun()
if st.sidebar.button("Pengumpulan UAS"):
    st.session_state['kondisi']={'awal':False,'contoh':False, 'Pertemuan1':False,'Pertemuan2':False,'Pertemuan3':False,
                                 'Pertemuan4':False,'Pertemuan5':False,'Pertemuan6':False,'Pertemuan7':False,'Pertemuan8':False,
                                 'Pertemuan9':False, 'Pertemuan10':False, 'Pertemuan11':False,'Pertemuan12':True}
    st.rerun()
